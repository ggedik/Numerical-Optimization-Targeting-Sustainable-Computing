...
V3 NOTEs
-----
+ r8_uniform is called in _f by all the other _f functions
++ function body and the return type is changed to float
+ log in dist2c_cf is changed to logf
+dist2c_cf input double e --> float e
====== in other parts e is still a double variable (as input to function or in the main body)
because it is most of the time passed as reference
it will get changed when I change the energy fucntion
======

----
mod in seed in r8_uniform will be handled as another chapter and other optimizations as such.
--------
