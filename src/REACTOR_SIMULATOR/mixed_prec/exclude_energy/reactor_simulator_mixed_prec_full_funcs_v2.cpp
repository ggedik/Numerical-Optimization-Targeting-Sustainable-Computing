 ...
 float dist2c_cf ( double e, int &seed );
...
//
{
  ...
  //s = r8_abs ( sinf ( 100.0 * ( expf ( e ) - 1.0 ) ) 
  // + sinf ( 18.81 * ( expf ( e ) - 1.0 ) ) );
...
//the problem of casting here will be 
//adressed when we modify to float the r8 uniform function
  u = r8_uniform_01 ( seed );
  mu = u;
