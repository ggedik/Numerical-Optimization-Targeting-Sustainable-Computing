...
//this is not called in this version, float mu and float azm are copied into double mu_d and double azm_d and
// when exited from the function they are copied back doubles === because passing by reference 
