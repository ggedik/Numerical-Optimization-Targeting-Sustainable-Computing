...
nb_elements = np.arange(500000,1500000,100000)
#nb_elements=np.arange(20000,50000,10000)
...
double_mean_arr_str = [str(x) for x in double_mean_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(double_mean_arr_str))
file_name = "double_median_arr.txt"
double_median_arr_str =[str(x) for x in double_median_arr] 
with open(file_name,'w') as file:
    file.write('\n'.join(double_median_arr_str))
file_name = "double_std_arr.txt"
double_std_arr_str = [str(x) for x in double_std_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(double_std_arr_str))
    
file_name = "double_var_arr.txt"
double_var_arr_str=[str(x) for x in double_var_arr]

with open(file_name,'w') as file:
    file.write('\n'.join(double_var_arr_str))
...
mixed_std_arr_str = [str(x) for x in mixed_std_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(mixed_std_arr_str))
    
file_name = "mixed_var_arr.txt"
mixed_var_arr_str = [str(x) for x in mixed_mean_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(mixed_var_arr_str))
    
file_name = "mixed_mean_arr.txt"
mixed_mean_arr_str =[str(x) for x in mixed_mean_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(mixed_mean_arr_str))
    
file_name = "mixed_median_arr.txt"
mixed_median_arr_str = [str(x) for x in mixed_median_arr]
with open(file_name,'w') as file:
    file.write('\n'.join(mixed_median_arr_str))
