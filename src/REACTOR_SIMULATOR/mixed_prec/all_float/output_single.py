...
srun ./reactor_simulator_double 0 1 1 {elm} > ./RS_double_elm{elm}.txt
srun ./reactor_simulator_single 0 1 1 {elm} > ./RS_single_prec23_elm{elm}.txt 
"""
    file_name=f"batch_single_elm{elm}.bat"
