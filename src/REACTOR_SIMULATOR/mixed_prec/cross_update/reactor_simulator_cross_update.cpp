...
float cross_f (double e);

 double dist2c ( double e, int &seed );
double dist2c_cf(double e, int &seed); 
...
void update_f(double mu, double azm, double d, double &x, double &y, double &z); 
//****************************************************************************80
...
float cross_f(double e)
{
  ...
  s = r8_abs ( sinf ( 100.0f * ( expf ( e ) - 1.0f ) ) 
